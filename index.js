...
function getArtistByIndex(array,int) {
  /*Your Code Here*/
  return `the artist at index ${int} is ${artists[int]['name']}`
...
function addArtist(array){
    array.push({
      ...
      years:1990-2021,
      nationality:'Italian',
      bio:'my name is Amanuel Gilay I love to dance',
